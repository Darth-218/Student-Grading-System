...
public class EnrollCourse {
  ...
  @FXML private TextField c_name;       // matches fx:id in FXML
  @FXML private TextField c_code;       // matches fx:id in FXML
  @FXML private TextField c_instractor; // matches fx:id in FXML
  @FXML private TextField c_credits;    // matches fx:id in FXML

  private Dialog<ButtonType> dialog; // reference to the dialog

  public void setDialog(Dialog<ButtonType> dialog) { this.dialog = dialog; }
